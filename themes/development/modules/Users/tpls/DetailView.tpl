    ...
    <ul class="nav nav-tabs">
        ...
        {if $config.enable_action_menu}
            <li id="tab-actions" class="dropdown">
                ...
                {{include file="themes/development/include/DetailView/actions_menu.tpl"}}
            </li>
        {/if}
    </ul>
        ...
        <div class="tab-content" style="padding: 0; border: 0;">
         {{/if}}
            ...
            {{if $useTabs}}
                    ...
                    {{if isset($tabDefs[$label_upper].newTab) && $tabDefs[$label_upper].newTab == true}}
                        {{if $tabCount == '0'}}
                            <div class="tab-pane-NOBOOTSTRAPTOGGLER active fade in" id='tab-content-{{$tabCount}}'>
                                {{include file='themes/development/include/DetailView/tab_panel_content.tpl'}}
                            </div>
                        {{else}}
                ...
                {* advanced users tab *}
                <div class="tab-pane-NOBOOTSTRAPTOGGLER fade" id='tab-content-{{$tabCount}}' >
                    {{include file='themes/development/modules/Users/tpls/DetailView-advanced-tab-content.tpl'}}
                </div>
                {if $SHOW_ROLES}
                    {{counter name="tabCount" print=false}}
