...
<div class="dashboard">
    ...
    <ul class="nav nav-tabs nav-dashboard">
        ...
        {if !$lock_homepage}
            <li id="tab-actions" class="dropdown">
                ...
                {include file='themes/development/include/MySugar/tpls/actions_menu.tpl'}
            </li>
        {/if}
    </ul>
    ...
    <div class="tab-content">
        {foreach from=$dashboardPages key=tabNum item=tab}
            ...
            {/if}
                <img src="themes/development/images/loading.gif" width="48" height="48" align="baseline" border="0" alt="">
            </div>
        {/foreach}
    </div>
</div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body" id="dashletsList">
                    <p><img src="themes/development/images/loading.gif" width="48" height="48" align="baseline" border="0" alt=""></p>
                </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p><img src="themes/development/images/loading.gif" width="48" height="48" align="baseline" border="0" alt=""></p>                </div>
                            ...
                            <div class="panel-heading">
                                <div>
                                    <div class="col-xs-10 col-sm-11 col-md-11">
                                        <div>
                                            <img src="themes/development/images/sub_panel/Tab.svg">
...
<script type="text/javascript" src="themes/development/include/MySugar/javascript/AddRemoveDashboardPages.js"></script>
<script type="text/javascript" src="themes/development/include/MySugar/javascript/retrievePage.js"></script>
