...
function retrieveData(page_id, callback){
    ...
    $("#pageContainer").html('<img src="themes/development/images/loading.gif" width="48" height="48" align="baseline" border="0" alt="">');
    $.ajax({
  ...
  $('.modal-add-dashboard').on('show.bs.modal', function (e) {
    ...
    $('.modal-edit-dashboard').on('show.bs.modal', function (e) {
        ...
        for(var tab = 0; tab < totalTabs; tab++) {
            ...
            if(tab != 0) {
                // add buttons
                var removeButton = $('<button class="btn btn-xs btn-danger"><img src="themes/development/images/id-ff-remove-nobg.svg"></button>');
