...
{if $hideTable == false}
	...
	<thead>
		...
		{include file='themes/development/include/ListView/ListViewPaginationTop.tpl'}
	</thead>
	<tbody>
	...
	<tfoot>
    {include file='themes/development/include/ListView/ListViewPaginationBottom.tpl'}
	</tfoot>
	</table></div>
{/if}
{if $contextMenus}
